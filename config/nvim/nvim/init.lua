...
pcall(function()
	...
	-- skip_confirm_for_simple_edits alone still confirms deletes and
	-- multi-moves, so force confirm=false for all oil saves. Trash stays
	-- on (delete_to_trash), so undos are via the trash (g\ to view).
	do
